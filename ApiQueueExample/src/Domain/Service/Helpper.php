...
final class Helper
{
     ...
     *
     * @param string $str      The string where to substitute values
     ...
     *
     * @return array with response's header and body.
     *
     */
    function curlCmd( string $url, $postdata = '', $qheaders = '', string $cmd='GET' ): array
    {
        $ch = curl_init($url);
